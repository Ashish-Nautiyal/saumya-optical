export const translations = {
  en: {
    ...
    contactSubheading:
      'Visit our store or reach out — we\'re happy to help you find the perfect vision solution.',
  ...
  hi: {
    ...
    heroStat1: '1000+',
    heroStat1Label: 'संतुष्ट ग्राहक',
    heroStat2: '10+',
    heroStat2Label: 'वर्षों का भरोसा',
    heroStat3: '100%',
    ...
    contactSubheading:
      'हमारे स्टोर पर आएं या संपर्क करें — सही दृष्टि समाधान खोजने में हम खुशी से मदद करेंगे।',
